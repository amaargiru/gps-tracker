...
// ѕровер€ем, приходило ли ранее сообщение от от такой пары masterLoginInput/masterPassInput
$result = mysql_query("SELECT lastlocationtime FROM gps_devices WHERE name='".$masterLoginInput."' AND pass='".$masterPassInput."'");
$row = mysql_fetch_array($result);
if ($row['lastlocationtime'] != ""){// —ообщение от masterLoginInput/masterPassInput уже приходило
...
else{// —ообщение от masterLoginInput/masterPassInput еще ни разу не приходило, создаем новую строку в базе
